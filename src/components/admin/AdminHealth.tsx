import { 
  ...
  CheckCircle, AlertTriangle, XCircle, RefreshCw, TrendingUp
} from "lucide-react";
...
const systemMetrics = [
  ...
  { label: "API Response", value: "124ms", status: "excellent", icon: Wifi },
  { label: "CPU Usage", value: "42%", status: "good", icon: Cpu },
  { label: "Memory", value: "68%", status: "good", icon: Server },
];
          ...
          <Card key={metric.label} className="bg-slate-900/50 border-slate-800 p-5">
            <div className="flex items-center justify-between">
              ...
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                metric.status === "excellent" ? "bg-emerald-500/20" : "bg-blue-500/20"
              }`}>
              ...
              <div key={resource.resource}>
                ...
                <Progress 
                  ...
                  className={`h-3 bg-slate-800 ${
                    resource.percentage > 80 ? "[&>div]:bg-amber-500" : ""
                  }`}
                />
              </div>
            ))}
          ...
          {recentIncidents.map((incident, i) => (
            ...
            >
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${
                incident.status === "resolved" ? "bg-emerald-500/20" :
